...
var _theme = require("./main/js/pageElements/theme.js");
var _addTest = require("./main/js/pageElements/addTest.js");
var _texts = require("./main/js/pageElements/texts.js");
...
exports.addHtmlToElement = addHtmlToElement;
...
exports.addSumbitTranslationEventOnClick = addSumbitTranslationEventOnClick;
function addSumbitTranslationEventOnClick(button, input, output, translator, unhideElements) {
  document.getElementById(button).addEventListener('click', () => {
    var translatedText = translator(document.getElementById(input).value.length > 0 ? document.getElementById(input).value : '');
...
var _index = require("../../../node_modules/@juliakramr/latynka/index.js");
const texts = {
  cyrToLatTest1: _index.klatinoid.tests.cyrToLatExperimentalSuite.testPayload[0].testPayload.input,
  latToCyrTest1: _index.klatinoid.tests.latToCyrExperimentalSuite.testPayload[0].testPayload.input,
  cyrToLatUvaga: `
...
exports.addToggleThemeEvent = addToggleThemeEvent;
function addToggleThemeEvent() {
  document.getElementById('theme').addEventListener('click', () => {
    window.matchMedia('(prefers-color-scheme: dark)').matches ? document.body.classList.toggle('light-mode') : document.body.classList.toggle('dark-mode');
  });
}
...
exports.addRunTestsOnClick = addRunTestsOnClick;
var _index = require("../../../node_modules/@juliakramr/latynka/index.js");
function addRunTestsOnClick(button, statusElement, output, successOutput, failOutput, unhideElements) {
  ...
  document.getElementById(button).addEventListener('click', () => {
    var {
      outPutLog,
      status
    } = _index.klatinoid.runTests(logLevel, experimental, future);
